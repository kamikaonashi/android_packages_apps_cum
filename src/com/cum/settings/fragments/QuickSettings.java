...
import com.cum.settings.preferences.SystemSettingEditTextPreference;
...
public class QuickSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.cum_settings_quicksettings);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQuickPulldown) {
            ...
            CumUtils.showSystemUiRestartDialog(getContext());
            return true;
        }
        return false;
    }
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.cum_settings_quicksettings;
                    result.add(sir);
                    return result;
                }
