/*
 * Copyright (C) 2019-2022 The CumOS Projects
 *
...
import com.cum.settings.fragments.UdfpsIconPicker;
...
public class Udfps extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.cum_settings_udfps);

        final PreferenceScreen prefSet = getPreferenceScreen();
        Resources resources = getResources();

        final boolean udfpsResPkgInstalled = CumUtils.isPackageInstalled(getContext(),
                "com.cum.udfps.resources");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.cum_settings_udfps);
}
